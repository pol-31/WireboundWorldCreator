...
// id 1 reserved for id (picking)
layout (location = 2) uniform vec3 sizes;
layout (location = 3) uniform vec3 center;
...
void main(){
    vec4 world_pos = model_mat * vec4(in_vertex * sizes + center, 1.0);
