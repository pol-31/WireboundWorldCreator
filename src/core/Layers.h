...
/// with
namespace Layers {
static constexpr JPH::ObjectLayer UNUSED1 =
    0;  // 4 unused values so that broadphase layers values don't match with
...
static constexpr JPH::ObjectLayer DEBRIS =
    6;  // Example: Debris collides only with NON_MOVING
static constexpr JPH::ObjectLayer SENSOR =
    7;  // Sensors only collide with MOVING objects
