...
inline constexpr std::array<std::uint8_t, 48> gWidths = {
    0,   149, 184, 26,  68,  104, 97,  96,  25,  136, 118, 88,
    135, 16,  104, 120, 135, 137, 89,  132, 8,   118, 212, 152,
    152, 136, 149, 216, 135, 54,  54,  103, 98,  87,  86,  100,
    7,   80,  240, 103, 118, 84,  112, 245, 116, 52,  48,  6,
};
/*inline constexpr std::array<std::uint8_t, 48> gWidths = {
