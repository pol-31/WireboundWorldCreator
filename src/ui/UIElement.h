...
using UIElementVector = JPH::Array<UIElement *>;
...
public:
  ...
  virtual ~UIElement();
	...
	void				StopAnimation(UiAnimationType type);
	...
	/// Manager
	UiScene *			GetManager() const							{ return mManager; }
	...
	virtual bool		HandleUIEvent(EUIEvent inEvent, UIElement *inSender);
