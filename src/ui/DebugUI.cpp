...
UIStaticText *DebugUI::CreateStaticText(UIElement *inMenu, const std::string_view &inText)
{
...
UITextButton *DebugUI::CreateTextButton(UIElement *inMenu, const std::string_view &inName, UITextButton::ClickAction inAction)
{
...
UICheckBox *DebugUI::CreateCheckBox(UIElement *inMenu, const std::string_view &inName, bool inInitiallyChecked, UICheckBox::ClickAction inAction)
{
...
UISlider *DebugUI::CreateSlider(UIElement *inMenu, const std::string_view &inName, float inInitialValue, float inMinValue, float inMaxValue, float inStepValue, UISlider::ValueChangedAction inAction)
{
...
UIComboBox *DebugUI::CreateComboBox(UIElement *inMenu, const std::string_view &inName, const std::vector<std::string> &inItems, int inInitialItem, UIComboBox::ItemChangedAction inAction)
{
	UIHorizontalStack *horiz = new UIHorizontalStack();
	horiz->SetPaddingRight(24);
	inMenu->Add(horiz);
