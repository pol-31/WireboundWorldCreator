#ifndef WIREBOUNDWORLDCREATOR_SRC_RENDERERS_GRASS_H_
#define WIREBOUNDWORLDCREATOR_SRC_RENDERERS_GRASS_H_
...
class Grass {
 public:
  ...
  // TODO: REMOVE compute shaders (bear functional into vertex/tessellation
  // shader.
 ...
 private:
  ...
  static std::vector<Blade> GenerateBlades(const std::vector<int>& points,
                                           const std::vector<uint8_t>& heights);
...
#endif  // WIREBOUNDWORLDCREATOR_SRC_RENDERERS_GRASS_H_
