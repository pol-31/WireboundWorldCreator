...
UiEditBiomes::UiEditBiomes(
    ...
    : Base({data::VboIdMain::kBiomesEditDesk}, 1.0f,
      ...
      color_palette_(
          {data::VboIdMain::kBiomesColorPaletteHS},
          {data::VboIdMain::kBiomesColorColorCursor}, glm::vec2{1.0f}),
      color_brightness_(
          {data::VboIdMain::kBiomesColorPaletteB},
      ...
      ui_event_handler_({
          &pin_, &value_config_.sl_strength_,
      ...
      value_config_(
          ui_shared_resources, text_renderer,
...
void UiEditBiomes::Generate() {
  ...
  ui_shared_resources_.global_glfw_callback_data_.tile_renderer
    ->environment_.SetEnvironment(
      biome.wind_speed, biome.wind_angle,
      biome.sun_direction, biome.sun_color);
}
...
void UiEditBiomes::RenderModelConfig() {
  ...
  value_config_.Render(
      instances_[selected_id_].wind_speed, next_offset,
      value_config_.pressed_strength_id_ == 0, data::TextId::kWindSpeed);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].wind_angle, next_offset,
      value_config_.pressed_strength_id_ == 1, data::TextId::kWindAngle);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_direction.x, next_offset,
      value_config_.pressed_strength_id_ == 2, data::TextId::kSunX);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_direction.y, next_offset,
      value_config_.pressed_strength_id_ == 3, data::TextId::kSunY);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_direction.z, next_offset,
      value_config_.pressed_strength_id_ == 4, data::TextId::kSunZ);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_color.x, next_offset,
      value_config_.pressed_strength_id_ == 5, data::TextId::kSunR);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_color.y, next_offset,
      value_config_.pressed_strength_id_ == 6, data::TextId::kSunG);
  next_offset.y -= entry_height;
  value_config_.Render(
      instances_[selected_id_].sun_color.z, next_offset,
      value_config_.pressed_strength_id_ == 7, data::TextId::kSunB);
}
