...
UiEditSlots::UiEditSlots(UiRenderData& render_data, WindowQueue& window_queue,
                         TextRenderer& text_renderer)
    : Base({data::UiId::kBiomesEditDesk, [] {}}, 1.0f,
           {{data::UiId::kBiomesEditDeskPinBack, [] {}},
            {data::UiId::kBiomesEditDeskPinPoint}},
           render_data, window_queue),
      accept_(data::UiId::kBiomesEditAccept, [this] { ui_edit_->Generate(); }),
      name_(text_renderer, {data::UiId::kBiomesEditNameBack},
            {data::UiId::kBiomesEditName}),
      color_palette_({data::UiId::kBiomesColorPaletteHS},
                     {data::UiId::kBiomesColorColorCursor}, glm::vec2{1.0f}),
      color_brightness_({data::UiId::kBiomesColorPaletteB},
                        {data::UiId::kBiomesColorBrightnessCursor}, 1.0f),
      color_indicator_(data::UiId::kBiomesColorIndicator),
      random_generate_(data::UiId::kBiomesEditRandomGeneration,
